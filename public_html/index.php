	...
	<div class="container">
		<div class="row">
			<div class="col-md-3 col-sm-6">
				<div class="thumbnail">
					<a href="./about/index.php"><img src="media/200/band2001.jpg"
																alt="Tree across trail, Bandelier National Monument"
																class="img-responsive img-thumbnail img-circle"></a>
					<div class="caption">
						<a href="./about/index.php"><h3 class="about">Highlights</h3></a>
			...
			<div class="col-md-3 col-sm-6">
				<div class="thumbnail">
					<a href="./portfolio/index.php"><img src="media/200/band2002.jpg"
																	 alt="Fall leaves at Bandelier National Monument"
																	 class="img-responsive img-thumbnail img-circle"></a>
					<div class="caption">
			...
			<div class="col-md-3 col-sm-6">
				<div class="thumbnail">
					<a href="./contact/index.php"><img src="media/200/band2003.jpg"
																  alt="Fall leaves at Bandelier National Monument"
																  class="img-responsive img-thumbnail img-circle"></a>
					<div class="caption">
			...
			<div class="col-md-3 col-sm-6">
				<div class="thumbnail">
					<a href="./projects/index.php"><img src="media/200/band2004.jpg"
																	alt="Looking down trail, Bandelier National Monument"
																	class="img-responsive img-thumbnail img-circle"></a>
					<div class="caption">
