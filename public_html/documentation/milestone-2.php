...
<html lang="en">
	...
	<body>
		<h2>Wyn-Tech.com Milestone 2&alpha;</h2>
		<h3>Proposed Site Map</h3>
		<p>Site will consist of 3 top-level pages total. No sub-pages or sub-navigation. This will be the Minimum Viable Product.</p>
		<ul>
			<li>Home Page</li>
		...
		<p><strong>Home Page: </strong>A brief introduction that introduces me and my role as a Web Developer, and will feature 2 calls to action that will direct the user to the About Me or the Portfolio page.</p>
		...
		<ol>
			...
			<li>1 minute look at the About Me page. Sees core skills featured in a contrasting side panel. The interaction stops here. Christa has decided, based on the information provided, that she will be contacting me regarding the website for Decor8-on-a-dime</li>
		</ol>
		<h3>Wireframes</h3>
		<p>This site will feature 2 layouts:</p>
		<ol>
		...
		<div id = "homemobile">
			...
			<img class="img1" src="../media/mobile-home.svg" alt="home page mobile wireframe">
		</div>
		<div id = "contentmobile">
			<h4>Content Page Layout: Mobile</h4>
			<img class="img2" src="../media/mobile-content.svg" alt="content page mobile 			wireframe">
		</div>
		<div id = "homedesktop">
			<h4>Home Page Layout: Desktop</h4>
			<img class="img3" src="../media/desktop-home.svg" alt="home page desktop wireframe">
		</div>
