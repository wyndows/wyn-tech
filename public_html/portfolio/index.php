	...
	<div id="portfolio">
		<div class="row">
			<div class="col-md-12">
				...
				<h4><strong>ROMuLess.com</strong></h4>
				<p>This web application is the capstone project for Deep Dive Coding Bootcamp. As part of a team of 3, I
					...
					website for the buying and selling of gaming cartridges. It is an ongoing project which I am working on.
					We used PHP, MySQL, JavaScript, Bootstrap and Angular 1.</p>
				<br>
				...
				<p>This is my personal website. This is an ongoing fun project that was part of Deep Dive Coding Bootcamp.
					...
					I
					added a page to it that shows some of my woodturning projects I was able to do recently. I wrote it
					using HTML, CSS3, Bootstrap and Angular 1.</p>
				<br>
				...
				<p>This is being written in Angular 2</p>
				<br>
